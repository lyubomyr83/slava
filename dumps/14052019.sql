...
INSERT INTO `pages` VALUES (1,'Главная','Контент главной страницы',1543330191,1556633675,'0'),(3,'Контакты','Контент контактов\r\n',1543330191,1543932948,'0'),(4,'Фотогалерея','Фото',1543330191,1543932833,'0'),(5,'Блог','',1543330191,NULL,'1'),(6,'Новости','новости',1543330191,NULL,'1');
...
-- Dump completed on 2019-05-14 17:45:04
